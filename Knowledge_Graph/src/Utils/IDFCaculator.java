...
//    public double CalTFIDF_ByWord(String word) {
//        double tfidf = 0;
//        if (IDFtree.getWordNode(word) != null)//语料IDF数据库中存在该词
//        {
//            double idf = (Double) IDFtree.getWordNode(word).obj;
////                if (idf != 0) {
////                    System.out.println(wn.getWord());
////                }
//            tfidf = (double) getFreq() / wordCount * idf;
//        } else {
//            wn.tfidf = (double) wn.getFreq() / wordCount * (double) Math.log(400);
//        }
//    }
